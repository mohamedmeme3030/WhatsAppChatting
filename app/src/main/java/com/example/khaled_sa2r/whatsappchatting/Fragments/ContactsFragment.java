package com.example.khaled_sa2r.whatsappchatting.Fragments;
...
import com.example.khaled_sa2r.whatsappchatting.MainProject.Contacts;
import com.example.khaled_sa2r.whatsappchatting.MainProject.FindFriendsActivity;
...
public class ContactsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myContactList=(RecyclerView) ContactsView.findViewById(R.id.contents_list);
                   ...
                   UsersRef.child(userIDs).addValueEventListener(new ValueEventListener() {
                       ...
                       public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                       {
                           if (dataSnapshot.hasChild("image"))
                           {
                               ...
                               Picasso.get().load(userImage).placeholder(R.drawable.profile_image).into(holder.profilImage);
                           }
                           else
                           {
                               String profilStatus = dataSnapshot.child("status").getValue().toString();
